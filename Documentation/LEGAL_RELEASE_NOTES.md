# BilLandar legal publication notes

This repository contains a public draft of the BilLandar legal and support pages in
`docs/`. The pages describe the current implementation: local SwiftData storage,
...
the legal publisher identity required for the territories where BilLandar will be
...
territories where BilLandar will be distributed.
