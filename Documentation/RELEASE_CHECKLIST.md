...
- [x] CloudKit uses a versioned SwiftData schema (`BilLandarSchemaV1`) and an explicit
  migration plan.
...
- [x] Public draft legal hub, Privacy Policy, Terms of Use, EULA note, and support/data-request pages are published at https://khakhasshi.github.io/BilLandar/.
...
- [ ] Confirm `iCloud.JIANGJINGZHE.BilLandar` exists and the production schema is
