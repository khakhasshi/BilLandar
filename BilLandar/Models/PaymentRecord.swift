...
enum PaymentStatus: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .paid: String(localized: "Paid", locale: BilLandarSharedStore.appLocale)
        case .pending: String(localized: "Pending", locale: BilLandarSharedStore.appLocale)
        case .failed: String(localized: "Failed", locale: BilLandarSharedStore.appLocale)
        case .refunded: String(localized: "Refunded", locale: BilLandarSharedStore.appLocale)
        }
    }
}
