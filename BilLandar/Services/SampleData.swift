    ...
    static var sampleBills: [Bill] {
        [
            Bill(
                ...
                cycle: .monthly,
                nextDueDate: .billandarDate(daysFromToday: 1),
            ...
            Bill(
                ...
                category: .entertainment,
                cycle: .monthly,
                nextDueDate: .billandarDate(daysFromToday: 4),
            ...
            Bill(
                ...
                cycle: .monthly,
                nextDueDate: .billandarDate(daysFromToday: 3),
                symbolName: "sparkles",
            ...
            Bill(
                ...
                category: .entertainment,
                cycle: .monthly,
                nextDueDate: .billandarDate(daysFromToday: 6),
            ...
            Bill(
                ...
                category: .entertainment,
                cycle: .monthly,
                nextDueDate: .billandarDate(daysFromToday: 8),
                status: .paused,
                symbolName: "sparkle",
            ...
            Bill(
                ...
                category: .other,
                cycle: .yearly,
                nextDueDate: .billandarDate(daysFromToday: 20),
            ...
            Bill(
                ...
                category: .productivity,
                cycle: .monthly,
                nextDueDate: .billandarDate(daysFromToday: 12),
    ...
    static func paymentHistory(for bills: [Bill]) -> [PaymentRecord] {
        var records = bills.flatMap { bill in
            ...
            return (1...recordCount).map { offset in
                ...
                switch bill.cycle {
                case .weekly:
                    paidAt = Calendar.billandar.date(byAdding: .weekOfYear, value: -offset, to: bill.nextDueDate) ?? bill.nextDueDate
                case .monthly:
                    paidAt = Calendar.billandar.date(byAdding: .month, value: -offset, to: bill.nextDueDate) ?? bill.nextDueDate
                case .quarterly:
                    paidAt = Calendar.billandar.date(byAdding: .month, value: -(offset * 3), to: bill.nextDueDate) ?? bill.nextDueDate
                case .yearly:
                    paidAt = Calendar.billandar.date(byAdding: .year, value: -offset, to: bill.nextDueDate) ?? bill.nextDueDate
                }
        ...
        if let pixelForge = bills.first(where: { $0.merchantIdentifier == "pixelforge-suite" }) {
            records.append(
                PaymentRecord(
                    ...
                    paidAt: .billandarDate(daysFromToday: -2),
                    status: .failed,
