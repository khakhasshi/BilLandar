        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    if let fallbackReason = BilLandarSharedStore.defaults.string(forKey: BilLandarSharedStore.Keys.cloudKitFallbackReason) {
                        Label {
