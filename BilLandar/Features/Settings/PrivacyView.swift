...
struct PrivacyView: View {
    private let legalBaseURL = URL(string: "https://khakhasshi.github.io/BilLandar/")!
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                ...
                privacySection(
                    "Payment information",
                    "BilLandar does not process payments and never asks for full card numbers, bank credentials, or security codes. Payment methods contain only labels and optional last-four-digit references."
                )
                privacySection(
                    "Exchange rates",
                    "BilLandar requests current and historical reference rates from Frankfurter. Requests contain currency codes and dates, not your bill names or payment details."
                )
                privacySection(
                    "Notifications",
                    "Bill reminders are scheduled locally on your device. You can disable them at any time in BilLandar or iOS Settings."
                )
                privacySection(
                    "Export",
