...
extension View {
    func billioCard(padding: CGFloat = 16) -> some View {
        modifier(BillioCardModifier(padding: padding))
    }
...
private struct BillioCardModifier: ViewModifier {
