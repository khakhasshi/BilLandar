...
enum PaymentStatus: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .paid: String(localized: "Paid", locale: BillowSharedStore.appLocale)
        case .pending: String(localized: "Pending", locale: BillowSharedStore.appLocale)
        case .failed: String(localized: "Failed", locale: BillowSharedStore.appLocale)
        case .refunded: String(localized: "Refunded", locale: BillowSharedStore.appLocale)
        }
    }
}
