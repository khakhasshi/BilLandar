...
final class Bill {
    ...
    var localizedSubtitle: String {
        ...
        return String(localized: String.LocalizationValue(subtitle), locale: BillowSharedStore.appLocale)
    }
    ...
    func renewalDate(after date: Date, calendar: Calendar = .billow) -> Date {
        switch cycle {
        case .weekly:
...
enum BillCategory: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .entertainment: String(localized: "Entertainment", locale: BillowSharedStore.appLocale)
        case .productivity: String(localized: "Productivity", locale: BillowSharedStore.appLocale)
        case .storage: String(localized: "Storage", locale: BillowSharedStore.appLocale)
        case .finance: String(localized: "Finance", locale: BillowSharedStore.appLocale)
        case .utilities: String(localized: "Utilities", locale: BillowSharedStore.appLocale)
...
enum BillingCycle: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .weekly: String(localized: "Every week", locale: BillowSharedStore.appLocale)
        case .monthly: String(localized: "Every month", locale: BillowSharedStore.appLocale)
        case .quarterly: String(localized: "Every 3 months", locale: BillowSharedStore.appLocale)
        case .yearly: String(localized: "Every year", locale: BillowSharedStore.appLocale)
        }
    }
}
...
enum BillStatus: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .active: String(localized: "Active", locale: BillowSharedStore.appLocale)
        case .paused: String(localized: "Paused", locale: BillowSharedStore.appLocale)
        case .cancelled: String(localized: "Cancelled", locale: BillowSharedStore.appLocale)
        }
    }
}
