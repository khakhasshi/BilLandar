...
enum BillowSharedStore {
    static let appGroupIdentifier = "group.JIANGJINGZHE.Billow"
    ...
    static func migrateLegacyDefaultsIfNeeded() {
        ...
        for key in ["displayCurrencyCode", "currencyCode", "billowThemeMode"] {
    ...
    enum Keys {
        ...
        static let themeMode = "billowThemeMode"
        static let languageIdentifier = "billowLanguageIdentifier"
    }
}
