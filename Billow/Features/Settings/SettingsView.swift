        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    if let fallbackReason = BillowSharedStore.defaults.string(forKey: BillowSharedStore.Keys.cloudKitFallbackReason) {
                        Label {
